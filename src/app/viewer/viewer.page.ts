  ...
  constructor(private router: Router, private actRoute: ActivatedRoute) {
   ...
   async ngOnInit() {
    this.imageList = [
      ...
      {
        url: 'https://i.picsum.photos/id/1009/5000/7502.jpg?hmac=Uj6crVILzsKbyZreBjHuMiaq_-n30qoHjqP0i7r30r8',
        title: 'Surfer',
      },
      {
    ...
    if (this.platform === 'ios') {
      this.imageList.push({
        url: 'file:///var/mobile/Media/DCIM/100APPLE/IMG_0001.JPG',
        title: 'Image1',
      });
      this.imageList.push({
        url: 'file:///var/mobile/Media/DCIM/100APPLE/IMG_0002.JPG',
        title: 'Image2',
      });
      this.imageList.push({
        url: 'capacitor://localhost/_capacitor_file_/var/mobile/Containers/Data/Application/0C6DDAA3-1486-43E1-A7A8-2E9B39107F32/Documents/photo1.jpg',
        title: 'ImageFromDocument',
      });
    }
    if (this.platform === 'android') {
      this.imageList.push({
        url: 'file:///sdcard/DCIM/IMG_0001.JPG',
        title: 'Image1',
      });
      this.imageList.push({
        url: 'file:///sdcard/DCIM/IMG_0002.JPG',
        title: 'Image2',
      });
      this.imageList.push({
        url: 'file:///sdcard/Pictures/IMG_0003.JPG',
        title: 'Image3',
      });
      this.imageList.push({
        url: 'http://localhost/_capacitor_file_/storage/emulated/0/Pictures/JPEG_20221001_113835_7582877022250987909.jpg',
        title: 'Imagelocalhost',
      });
      this.imageList.push({
        url: 'capacitor://localhost/_capacitor_file_/storage/emulated/0/Pictures/JPEG_20221001_102529_2463134056977343449.jpg',
        title: 'Imagelocalhost',
      });
    }
    this.startFrom = 2;
    const pathIOS = Capacitor.convertFileSrc(
      'file:///var/mobile/Media/DCIM/100APPLE/IMG_0001.JPG'
    );
    const pathAndroid = Capacitor.convertFileSrc(
      'file:///sdcard/DCIM/IMG_0001.JPG'
    );
